  ...
  return (
    <div>
      ...
      <div className="container text-center">
        ...
        <div style={{backgroundColor: "#F7F5F9", display: "flex", justifyContent: "center", width: "100%", padding: "50px 100px"}}>
    <div style={{color: "#08090A"}}>© Purple Cues Private Limited</div>
    </div>
    </div>
  )
}
